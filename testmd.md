...
- XSD (XML Schema definition) is used for validating XML. IDE's like Netbeans, Eclipse and some Editors provide suggestions in the XML file based on XSD provided. NetBeans is one example of a tool to validate and check XML.
